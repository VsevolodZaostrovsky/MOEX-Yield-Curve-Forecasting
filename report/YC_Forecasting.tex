\section{Yield Curve Forecasting}
    ...
    \subsection{Na\"ive approach for the bond yield forecasting}
        ...
        \subsubsection{Auto-ARIMA}
            We assumed the ARIMA model set for the bond yields. The model is defined as follows:
            ...
            \end{equation}
            where $\epsilon_t$ is the white noise with zero mean and variance $\sigma^2$, and $\Delta$ is a first difference operator.
        ...
        \subsubsection{Vector Error Correction}
            We assumed the VEC model for the bond yields. The model is defined as follows:
            \begin{equation}\label{eq:VEC}
                \Delta y_{t} = \Pi y_{t-1} + A_0 + A_1 \Delta y_{t-1} + \dots + A_p \Delta y_{t-p} + \epsilon_t. 
            \end{equation}
            where $\epsilon_t$ is the white noise with zero mean and variance $\sigma^2$.
